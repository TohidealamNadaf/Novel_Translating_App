...
Future<void> main() async {
  ...
  final wasmReq = await HttpClient().getUrl(Uri.parse('https://raw.githubusercontent.com/tekartik/sqflite/master/packages_web/sqflite_common_ffi_web/lib/assets/sqlite3.wasm'));
