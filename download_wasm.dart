...
Future<void> main() async {
  final baseUrl = 'https://github.com/simolus3/sqlite3.dart/raw/main/sqlite3/assets';
  
  print('Downloading sqlite3.wasm...');
  final wasmReq = await HttpClient().getUrl(Uri.parse('${baseUrl}/sqlite3.wasm'));
  ...
  final swReq = await HttpClient().getUrl(Uri.parse('https://raw.githubusercontent.com/tekartik/sqflite/master/sqflite_common_ffi_web/lib/assets/sqflite_sw.js'));
